...
export default function Quote() {
  return (
    <div className="quote">
      <h5 className="title">Embark on a space journey</h5>
      <p className="description">
        ...
        and galaxies, then our company is ready to help you realize this dream.
        We offer a unique experience that will allow you
        to go on a space journey and see all the secrets of the universe.
        We guarantee that every moment in space will be filled
        with incredible impressions, excitement and new discoveries.
